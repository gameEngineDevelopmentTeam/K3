...
class Transformation {
    ...
    internal fun getProjectionMatrix(fov: Float, width: Int, height: Int, zNear: Float, zFar: Float): Matrix4f =
            projectionMatrix.setPerspective(fov, width.toFloat() / height.toFloat(), zNear, zFar)

    internal fun getWorldMatrix(offset: Vector3f, rotation: Vector3f, scale: Float): Matrix4f =
